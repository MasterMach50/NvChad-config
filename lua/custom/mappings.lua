...
M.nvimtree = {
    ...
    n = {
        -- toggle
        ["<A-e>"] = { "<cmd> NvimTreeToggle <CR>", "󰙅 toggle nvimtree" },
        -- focus
        ["<S-e>"] = { "<cmd> NvimTreeFocus <CR>", "󰙅 focus nvimtree" },
    },
}
...
M.telescope = {
  ...
  n = {
    ...
    ["<leader>fk"] = { "<cmd> Telescope keymaps <CR>", "  find keybinds" },
